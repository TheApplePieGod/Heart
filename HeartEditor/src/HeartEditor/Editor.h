...
namespace HeartEditor
{
    ...
    public:
        ...
        static void SetActiveSceneFromAsset(Heart::UUID uuid);
        static bool IsDirty();
        ...
        inline static Heart::UUID GetActiveSceneAsset() { return s_ActiveSceneAsset; }
    ...
    private:
        ...
        static Heart::UUID s_ActiveSceneAsset;
