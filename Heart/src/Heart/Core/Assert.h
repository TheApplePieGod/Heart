#pragma once
    ...
    #define HL_INTERNAL_ASSERT_MSGARGS(type, check, msg, ...) FL_INTERNAL_ASSERT_IMPL(task, check, "Assertion failed: " msg, __VA_ARGS__)
    ...
    #define HE_INTERNAL_ASSERT_FIND(_1, _2, _3, _4, _5, macro, ...) macro
    #define HE_INTERNAL_ASSERT_PICK(...) HE_EXPAND_ARGS( HE_INTERNAL_ASSERT_FIND(__VA_ARGS__, HE_INTERNAL_ASSERT_MSGARGS, HE_INTERNAL_ASSERT_MSGARGS, HE_INTERNAL_ASSERT_MSGARGS, HE_INTERNAL_ASSERT_MSG, HE_INTERNAL_ASSERT_NOMSG) )
