#pragma once
    ...
    #define HT_INTERNAL_ASSERT_FIND(_1, _2, _3, _4, macro, ...) macro
    #define HT_INTERNAL_ASSERT_PICK(...) HT_EXPAND_ARGS( HT_INTERNAL_ASSERT_FIND(__VA_ARGS__, HT_INTERNAL_ASSERT_MSG, HT_INTERNAL_ASSERT_MSG, HT_INTERNAL_ASSERT_MSG, HT_INTERNAL_ASSERT_NOMSG) )
