...
namespace Heart
{
    ...
    public:
         ...
         */
        SceneAsset(const HStringView& path, const HStringView& absolutePath)
    ...
    public:
         ...
         */
        static Ref<Scene> DeserializeScene(const HStringView& path);
         ...
         */
        static void SerializeScene(const HStringView& path, Scene* scene);
